...
function $(o) {
 ...
 var g = require('./postprocessors'); var grammar = {
    ...
    {"name": "stmt$ebnf$1$subexpression$1", "symbols": ["stmtList", "_"]},
    {"name": "stmt$ebnf$1", "symbols": ["stmt$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "stmt$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "stmt", "symbols": [{"literal":"{"}, "_", "stmt$ebnf$1", {"literal":"}"}], "postprocess": g.stmtBlock},
    {"name": "stmt", "symbols": ["stmts"], "postprocess": g.stmt},
    {"name": "stmtList", "symbols": ["stmt"], "postprocess": g.stmtListSingle},
    {"name": "stmtList", "symbols": ["stmtList", "__", "stmt"], "postprocess": g.stmtList},
    {"name": "stmts", "symbols": ["expr"], "postprocess": id},
    {"name": "stmts", "symbols": ["comment"], "postprocess": id},
    {"name": "stmts", "symbols": ["if"], "postprocess": id},
    {"name": "stmts", "symbols": ["while"], "postprocess": id},
    {"name": "stmts", "symbols": ["assign"], "postprocess": id},
    {"name": "stmts", "symbols": ["return"], "postprocess": id},
    {"name": "stmts", "symbols": ["class"], "postprocess": id},
    ...
    {"name": "if", "symbols": ["if$string$1", "__", "expr", "__", "stmt", "if$ebnf$1", "if$ebnf$2"], "postprocess": g.if_},
    ...
    {"name": "while", "symbols": ["while$string$1", "__", "expr", "__", "stmt"], "postprocess": g.while_},
    ...
    {"name": "return", "symbols": ["return$string$1", "__", "stmt"], "postprocess": g.return_},
    ...
    {"name": "class", "symbols": ["class$string$1", "__", "id", "class$ebnf$1", "methodList"], "postprocess": g.class_},
    {"name": "func$string$1", "symbols": [{"literal":"f"}, {"literal":"u"}, {"literal":"n"}, {"literal":"c"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "func", "symbols": ["func$string$1", "__", "id", "argDefList", "stmt"], "postprocess": g.func},
    ...
    {"name": "closure", "symbols": ["closure$string$1", "__", "id", "argDefList", "stmt"], "postprocess": g.closure},
    ...
    {"name": "argCallList", "symbols": [{"literal":"("}, "argCallList$ebnf$1", {"literal":")"}], "postprocess": g.argCallList},
    ...
    {"name": "argDefList", "symbols": [{"literal":"("}, "argDefList$ebnf$1", {"literal":")"}], "postprocess": g.argDefList},
    ...
    {"name": "method", "symbols": ["id", "argDefList", "stmt"], "postprocess": g.method},
    ...
    {"name": "elseif", "symbols": ["_", "elseif$string$1", "__", "expr", "__", "stmt"], "postprocess": g.elseif},
    {"name": "else$string$1", "symbols": [{"literal":"e"}, {"literal":"l"}, {"literal":"s"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "else", "symbols": ["_", "else$string$1", "__", "stmt"], "postprocess": g.else}
]
  , ParserStart: "final"
}
